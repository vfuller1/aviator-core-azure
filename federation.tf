resource "azurerm_federated_identity_credential" "aviator_federated_credential" {
  # Changed name to v2 to resolve the 409 Conflict error
  name                = "fic-aviator-core-v2"
  resource_group_name = "rg-aviator-core-prod"
  audience            = ["api://AzureADTokenExchange"]

  # This matches the OIDC issuer URL for your East US 2 AKS cluster
  ...
  # This MUST match the serviceAccountName in your deployment.yaml
